...
public class NegroMinionEntity extends SlaveModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.3f, 0.9f)).build("negro_minion").setRegistryName("negro_minion");
	public NegroMinionEntity(SlaveModModElements instance) {
		super(instance, 147);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(SlaveModItemGroup.tab))
				.setRegistryName("negro_minion_spawn_egg"));
	}
