...
public class NigraniumnuggetItem extends SlaveModModElements.ModElement {
	@ObjectHolder("slave_mod:nigraniumnugget")
	public static final Item block = null;
	public NigraniumnuggetItem(SlaveModModElements instance) {
		super(instance, 68);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("nigraniumnugget");
		}
