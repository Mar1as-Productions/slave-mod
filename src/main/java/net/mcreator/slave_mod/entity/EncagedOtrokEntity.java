...
public class EncagedOtrokEntity extends SlaveModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("encaged_otrok").setRegistryName("encaged_otrok");
	public EncagedOtrokEntity(SlaveModModElements instance) {
		super(instance, 133);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16737895, new Item.Properties().group(SlaveModItemGroup.tab))
				.setRegistryName("encaged_otrok_spawn_egg"));
	}
