...
package net.mcreator.slave_mod.entity;
...
import net.mcreator.slave_mod.procedures.StrachProcedure;
import net.mcreator.slave_mod.procedures.SlaveEntityDiesProcedure;
...
public class SlaveEntity extends SlaveModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("slave").setRegistryName("slave");
	public SlaveEntity(SlaveModModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9283052, -13949916, new Item.Properties().group(SlaveModItemGroup.tab))
				.setRegistryName("slave_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 20, 5, 8));
		}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, SlaveEntity.CustomEntity.class, false, true));
			...
			this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, SlaveEntity.CustomEntity.class, false, true));
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, EndermanEntity.class, false, true));
			this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, EncagedOtrokEntity.CustomEntity.class, false, true));
			this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, PillagerEntity.class, false, true));
			this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, EncagedOtrokEntity.CustomEntity.class, false, true));
			this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, SpiderEntity.class, false, true));
			...
			this.goalSelector.addGoal(19, new BreakBlockGoal(Blocks.BELL, this, 1, (int) 100));
			this.goalSelector.addGoal(20, new FollowMobGoal(this, (float) 1, 10, 5));
			this.goalSelector.addGoal(21, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(22, new SwimGoal(this));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				SlaveEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		protected void registerAttributes() {
			...
			this.getAttribute(SharedMonsterAttributes.ATTACK_KNOCKBACK).setBaseValue(1.25D);
		}
	}
}
