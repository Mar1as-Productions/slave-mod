...
import net.mcreator.slave_mod.procedures.SlaveBossEntityDiesProcedure;
...
public class SlaveBossEntity extends SlaveModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13491692, -598156, new Item.Properties().group(SlaveModItemGroup.tab))
				.setRegistryName("slave_boss_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelnoplesruler(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("slave_mod:textures/noples_ruler.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(19, new BreakBlockGoal(Blocks.BELL, this, 1, (int) 1));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				SlaveBossEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(190);
			if (this.getAttribute(SharedMonsterAttributes.ARMOR) != null)
				this.getAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(1.6);
			...
			this.getAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).setBaseValue(0.7999999999999999D);
	...
	public static class Modelnoplesruler extends EntityModel<Entity> {
