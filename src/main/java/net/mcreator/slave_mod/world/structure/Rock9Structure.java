...
public class Rock9Structure extends SlaveModModElements.ModElement {
			...
			if ((random.nextInt(1000000) + 1) <= 5000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
							.getTemplateDefaulted(new ResourceLocation("slave_mod", "rock9"));
					if (template == null)
						return false;
	...
	public Rock9Structure(SlaveModModElements instance) {
		super(instance, 58);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("rock_9"));
	}
