...
import net.mcreator.slave_mod.procedures.HutTAdditionalGenerationConditionProcedure;
...
public class HutStructure extends SlaveModModElements.ModElement {
	...
	public HutStructure(SlaveModModElements instance) {
		super(instance, 11);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("hut"));
	}
