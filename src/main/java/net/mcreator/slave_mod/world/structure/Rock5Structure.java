...
package net.mcreator.slave_mod.world.structure;
...
public class Rock5Structure extends SlaveModModElements.ModElement {
			...
			if ((random.nextInt(1000000) + 1) <= 5000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
							.getTemplateDefaulted(new ResourceLocation("slave_mod", "rock5.1"));
					if (template == null)
						return false;
	...
	public Rock5Structure(SlaveModModElements instance) {
		super(instance, 54);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("rock_5"));
	}
