...
public class Rock6Structure extends SlaveModModElements.ModElement {
			...
			if ((random.nextInt(1000000) + 1) <= 5000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
							.getTemplateDefaulted(new ResourceLocation("slave_mod", "rock6.1"));
					if (template == null)
						return false;
	...
	public Rock6Structure(SlaveModModElements instance) {
		super(instance, 55);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("rock_6"));
	}
