...
public class Rock7Structure extends SlaveModModElements.ModElement {
			...
			if ((random.nextInt(1000000) + 1) <= 5000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
							.getTemplateDefaulted(new ResourceLocation("slave_mod", "rock7.1"));
					if (template == null)
						return false;
	...
	public Rock7Structure(SlaveModModElements instance) {
		super(instance, 56);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("rock_7"));
	}
